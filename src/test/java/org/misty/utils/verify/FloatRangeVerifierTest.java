...
public class FloatRangeVerifierTest {
    ...
    public void constructor() {
        ...
        rangeVerifier = Verifier.ofRange(title, 1f, 1f);
        rangeVerifier = Verifier.ofRange(title, 1f, 2f);
    ...
    public void requireInclusive() {
        ...
        BiConsumer<String, FloatRangeVerifier> test = (title, rangeVerifier) -> { // 測試 [1, 3]
            // 測試檢查通過的情況
