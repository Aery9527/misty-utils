...
public class DoubleRangeVerifierTest {
    ...
    public void constructor() {
        ...
        rangeVerifier = Verifier.ofRange(title, 1d, 1d);
        rangeVerifier = Verifier.ofRange(title, 1d, 2d);
    ...
    public void requireInclusive() {
        ...
        BiConsumer<String, DoubleRangeVerifier> test = (title, rangeVerifier) -> { // 測試 [1, 3]
            // 測試檢查通過的情況
