...
class BiIntConsumerExTest {

    @Test
    void execute() {
        BiIntConsumerEx consumerEx1 = (arg1, arg2) -> FunctionalInterfaceExTest.throwIOException(); // there is no need for a try-catch.
        testThrow(consumerEx1, IOException.class);

        BiIntConsumerEx consumerEx2 = (arg1, arg2) -> FunctionalInterfaceExTest.throwInterruptedException(); // there is no need for a try-catch.
        testThrow(consumerEx2, InterruptedException.class);
    }

    void testThrow(BiIntConsumerEx target, Class<? extends Exception> checkExceptionType) {
        ...
        BiIntConsumerEx testWrap = (arg1, arg2) -> {
            tempArg1.set(arg1);
            tempArg2.set(arg2);
