...
public class IntRangeBuilder {
    ...
    public IntRangeBuilder giveLowerBound(int min, int max) {
        Verifier.requireIntLessThanInclusive("lowerMin", min, "lowerMax", max);
    ...
    public IntRangeBuilder giveUpperBound(int min, int max) {
        Verifier.requireIntLessThanInclusive("upperMin", min, "upperMax", max);
        IntRangeVerifier rangeVerifier = Verifier.ofRange(min, max);
    ...
    public IntRange build(int lower, int upper) {
        ...
        Verifier.requireIntLessThanInclusive("lower", lower, "upper", upper);
