...
public class LongLimiterBuilderTest {
    ...
    public void min_max() {
        ...
        test.accept(LongLimiterBuilder::withVolatile);
        test.accept(LongLimiterBuilder::withAtomic);
    }
    ...
    public void verifyMinLessThanMax() {
        ...
        AssertionsEx.awareThrown(() -> limiterBuilder.giveMinLimit(1l, true).giveMaxLimit(0l, true).build(0l))
