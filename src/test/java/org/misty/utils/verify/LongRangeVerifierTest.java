...
public class LongRangeVerifierTest {
    ...
    public void constructor() {
        ...
        AssertionsEx.assertThrown(() -> Verifier.ofRange(1L, 0L))
                .hasMessageContaining(String.format(Verifier.ErrorMsgFormat.LESS_THAN_INCLUSIVE, "min", 1L, "max", 0L))
    ...
    public void requireInclusive() {
        ...
        LongRangeVerifier rangeVerifier = Verifier.ofRange(min, max); // [1, 3]
