...
public class DoubleLimiterBuilderTest {
    ...
    public void verifyMinLessThanMax() {
        ...
        AssertionsEx.assertThrown(() -> limiterBuilder.giveMinLimit(1d, true).giveMaxLimit(0d, true).build(0d))
    ...
    public void buildMinLimitInclusiveVerifier() {
        ...
        AssertionsEx.assertThrown(() -> limitVerifier.verifyPlus(min, -1f)) // min + -1 < min, 超過下限
                .hasMessage(
    ...
    public void buildMinLimitExclusiveVerifier() {
        ...
        // verifyPlus
        limitVerifier.verifyPlus(min, 1); // min + 1 > min, 允許大於下限
        AssertionsEx.assertThrown(() -> limitVerifier.verifyPlus(min + 1, -1f)) // (min+1) - 1 = min, 不允許等於下限
                .hasMessage(
